...
import Psmartfarming from '../../assets/img/precision-farming-for-beginners-guide-to-using-e-crop-effectively-2.webp'
import './Blogdetail.css'
import Breadcrumb from '../Breadcrumb';
import Seo from '../Seo';
const Precision_Farming_For_Beginners_Guide_To_Using_Ecrop_Effectively = () => {
     ...
     <div className='row'>
      <div className='col-lg-8'>
       ...
       <div className='col-lg-4 boost-img'>
        <img src={Psmartfarming} className='w-100' alt="farming"/>
        </div>
       </div>
       <h5>Conclusion:</h5>
...
export default Precision_Farming_For_Beginners_Guide_To_Using_Ecrop_Effectively;
