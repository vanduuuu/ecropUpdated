            ...
            <div className="container">
                <div className="in-divv">
                    <div className="h-quot why-choose-one__more-choose--title" data-aos="fade-up">
                        <p>Welcome to the future of agriculture with Smart e-Crop, an advanced solution designed to bring smart farming to every field. Developed by the renowned ICAR-CTCRI and brought to market by Precision Grow, Smart eCrop integrates cutting-edge technology with practical farming needs, making smart farming a reality for all.</p>
                    </div>
                </div>
            </div>
